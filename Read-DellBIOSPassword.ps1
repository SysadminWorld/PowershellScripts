Function Read-DellBIOSPassword {
<#
  .Synopsis 
  ...
  .Example
    $SecureStringPwd = read-DellBIOSPassword
...
Param (
  ...
  [Parameter(Mandatory=$false,ValueFromPipelineByPropertyName=$true,ValueFromPipeline=$false, position=1, HelpMessage="Encryption Key")] [byte []] $Key 
 ) 
...
PROCESS {
   ...
   #     $password=ConvertTo-SecureString -Key $KeyBytes -String $xml.Credential.Password 
         $password=ConvertTo-SecureString -Key $Key -String $xml.Credential.Password 
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDZkPHzbzNUCBxH
# 07osa1b3Bm9CKX/d/540FJtvCEI4MaCCCiMwggTCMIIDqqADAgECAhANhLMrA8kb
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgmy0M79Zk
# u4yiQBHTDcasuNEg0fdKxFJ6m40beT2b9FgwQAYKKwYBBAGCNwIBDDEyMDCgFoAU
# AEQAZQBsAGwALAAgAEkAbgBjAC6hFoAUaHR0cDovL3d3dy5kZWxsLmNvbSAwDQYJ
# KoZIhvcNAQEBBQAEggEAW9orPw3wXbG739Jx62iXgH5OzDDSihJJ4zn/NwoIyq5G
# 0LMdzOvjnExEAXXrmVTsavBmL9RKSY0lMHe+4aIDUzXs+RFA8J5BHY6GztggXzZW
# oGrfeDZh9Mwr261Heqtdnojndut7T0J2i+Brr1a0+AhTjNN2VBOZER6qXV0LNTvz
# JjvZTrnqCR4+BVstJEZqABYS4rmNkZyZJgx9KTHZuaOZXphILmC9FfiGmUP5qKeR
# Smrs5pEdEGlSB6g+q+icU2phTPNgs+5wXjM9Snq7RDW22QlNWcX8OHWGUDbRH5PM
# 4j/ccktltMnkN7O4yXICwN2Hl+ZKAO/zNiA7zia5xaGCDdYwgg3SBgorBgEEAYI3
...
# ZQMEAgEFAAQgpg44AeDRZJecxaQT+M+Iew8y7fKKEZmm9iYiEnnW+o8CBTEsxKIS
# GA8yMDE4MDUxNTA3MDAwMVqgggqFMIIFADCCA+igAwIBAgIBBzANBgkqhkiG9w0B
...
# hkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMTgwNTE1MDcwMDAxWjArBgsqhkiG
# 9w0BCRACDDEcMBowGDAWBBQNXjR81bN5Ps/q5rhg2w9VXb4kpTAvBgkqhkiG9w0B
# CQQxIgQgXwnm2o8BDKLCcyWxIUhlxMkDOJebU3YeI5rKIbglWQYwDQYJKoZIhvcN
# AQEBBQAEggEAAUmnGnQTMiBQlIbhYxnTvidwQhgdbWutRBbc9oKVzV+D+42nNXen
# NrSYg7C2vFGjLiAm3+5jOw80UfWS1jSTmjK3NxK+EeeSf6K6wolafOzXzLpUNgl/
# TSEpU24ytqvcv2itO/I2rcVd9Ul5NbcXIsNN5eHHpdrwz7t6nfsPLC4y+3zlEdYa
# osd6BuZhuDDZsOikoJpBMauSHWtueVpaaj2FYSF1tQ4QqC8yXq5FEyjxfOzySuRQ
# JaJMIGwhtlbeJTv5fvJ4X6N5DPxyPdajhgUzHOfCa2NY54T3+2SJBIHpztQUL0hC
# cjMWa83dpJjc6kst3PjcRbmofhJfqA3bhA==
