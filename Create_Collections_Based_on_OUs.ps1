...
$OUs = Get-ADOrganizationalUnit -LDAPFilter "(name=*)" -SearchScope SubTree -SearchBase $OUSearchBase
...
#
#.\Create-CollectionsFromOUs.ps1 -OUSearchBase "OU=ITServices,OU=Computers,OU=Anc,OU=UAA,DC=ua,DC=ad,DC=alaska,DC=edu" -LimitingCollection "All Systems" -MembershipRule "Query" -CollectionFolder "Active Directory Collections"
#