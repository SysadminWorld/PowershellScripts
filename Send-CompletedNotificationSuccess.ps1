...
$body = ConvertTo-Json -Depth 4 @{
  ...
  sections = @(
    @{
      activityTitle    = '<h1 style=color:blue;>Upgrade Successful'
      activitySubtitle = 'Windows Upgrade'
      #activityText	 = ' '
      activityImage    = 'http://uaa.alaska.edu//about/administrative-services/departments/information-technology-services/our-services/endpoint-management/_images/Checkmark.png' # this value would be a path to a nice image you would like to display in notifications
    },
    @{
