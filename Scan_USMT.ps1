...
$Output = Start-Process -FilePath "$ScriptPathParent\scanstate.exe" -ArgumentList "$StorePath\$env:computername /i:$ScriptPathParent\migdocs.xml /i:$ScriptPathParent\migapp.xml /ue:* /ui:ua\* /v:5 /c /o /vsc" -Wait
